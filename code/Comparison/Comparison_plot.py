...
# Paths to log files
log_file_path_1 = '../../YOLOX_outputs/yolox_nano_deploy_relu_bird_exp2/train_log.txt'
log_file_path_2 = '../../YOLOX_outputs/yolox_nano_deploy_relu_qat_bird/train_log.txt'
...
plt.plot(loss_data_1['Epoch'], loss_data_1['Total Loss'], label='Total Loss (Second Training)', color='blue')
plt.plot(loss_data_2['Epoch'], loss_data_2['Total Loss'], label='Total Loss (QAT Training)', color='red')
plt.xlabel('Epoch')
...
plt.savefig("/home/vitis-ai-user/yolonano/code/Comparison/images2.2/TotalLossPlot.png")

# Plotting AP over Epochs
plt.figure(figsize=(12, 8))
plt.plot(ap_data_1['Epoch'], ap_data_1['AP'], label='AP (Second Training)', color='green')
plt.plot(ap_data_2['Epoch'], ap_data_2['AP'], label='AP (QAT Training)', color='orange')
plt.xlabel('Epoch')
...
plt.savefig("/home/vitis-ai-user/yolonano/code/Comparison/images2.2/AP_Plot.png")
